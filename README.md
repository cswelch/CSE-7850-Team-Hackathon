...
* Open the file Active_learning/Final_Active_Learning.ipynb.
...
* The training and validation loss and Spearman R values, respectively, are plotted with respect to the average over all cross-validation folds in the "Plot CV curves" section:
